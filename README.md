...
```bash
git clone https://github.com/akashgarg04/okta-node-express.git
cd okta-node-express
```
...
* Give your application a name (e.g. "Sample Node Auth App")
...
Activate the environmental variables 
